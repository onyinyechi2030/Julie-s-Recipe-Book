# Julie's Recipe Book v17 — Firebase Sync
...
## Version 17 fix
The Google sign-in button now uses the app accent color directly and expands to a full-width visible button on phones.
